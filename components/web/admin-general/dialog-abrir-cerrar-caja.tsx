...
export function DialogAbrirCerrarCaja({ cajaId, sesionAbiertaId, abierta, montoReferencia, abierto, onOpenChange }: Props) {
  ...
  return (
    <Dialog open={abierto} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-md">
        <DialogHeader>
          <DialogTitle>{abierta ? "Cerrar caja" : "Abrir caja"}</DialogTitle>
        </DialogHeader>
